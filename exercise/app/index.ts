...
export = async () => {
    ...
    const regions: Array<string> = await netStackRef.("regions");   /* FIXME */
    const vpcs: Array<string> = await netStackRef.("vpcs");         /* FIXME */
    const publicSubnets: Array<string> = await netStackRef.("publicSubnets"); /* FIXME */
